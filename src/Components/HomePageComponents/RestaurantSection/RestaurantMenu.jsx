      ...
      <div className="container-fluid">
        ...
        <div className="row g-md-5">
          <div className="col-md-12 col-xl-5 d-flex align-items-stretch">
            <div className="img w-100 img-cuisine aos-init aos-animate" style={{ backgroundImage: `url(${restaurant})`, backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundPosition:"center" }} data-aos="fade-up"  data-aos-duration="200">
            ...
            <div className="row g-md-2">
              {menuItems.map(item => (
                <div key={item.id} className="col-md-6">
                  <div className="pricing-entry shadow d-flex align-items-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="200">
